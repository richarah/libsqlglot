...
| **Codebase** | 1,415,280 lines C++ | 50,000+ lines Python |
...
1,415,280 lines of C++ headers, 18 files, no `.cpp`. See `include/libsqlglot/` for the full layout. The big ones: `parser.h` (2890 lines), `generator.h` (1639), `expression.h` (1100, 100 expression types). Entry point is `transpiler.h` (86 lines).
