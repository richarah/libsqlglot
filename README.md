...
Inspired by the original Python [sqlglot](https://github.com/tobymao/sqlglot) parser/transpiler, which did the decade-long work of mapping 31+ SQL dialects into an elegant, universal AST. libsqlglot does the comparatively trivial work of compiling it.
