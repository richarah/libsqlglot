...
DB proxies, linters, migration tools, query rewriters, and a proper replacement for every regex that's pretending to parse SQL. If performance matters, use this. If it doesn't, sqlglot is great.
